...
namespace UnitTestProject1
{
    ...
    public class UnitTest1
    {
        ...
        public void SortByName()
        {
            ...
            actualDataFirstList=userListFirst.OrderBy(us => us.Name).ToList();
        ...
        public void SortByNameDescending()
        {
            ...
            //ToDo Add code first list
            actualDataFirstList = userListFirst.OrderByDescending(us => us.Name).ToList();
            Assert.IsTrue(actualDataFirstList[0].Equals(expectedData));
        ...
        public void SortByNameAndAge()
        {
            ...
            actualDataSecondList = userListSecond.OrderBy(us => us.Name).ThenBy(u=>u.Age).ToList();
        ...
        public void SelectsValuesByNameMax()
        {
            ...
            actualData = userListSecond.Where(us => us.Name == "Max").ToList();
            CollectionAssert.AreEqual(expectedData, actualData);
        }
        ...
        public void ContainOrNotContainName()
        {
            ...
            //name max 
            //ToDo Add code for second list
            isContain = userListSecond.Exists(us => us.Name == "Max");
            Assert.IsTrue(isContain);

            // name obama
            //ToDo add code for second list
            isContain = userListSecond.Exists(us => us.Name == "Obama");
        ...
        public void AllListWithName()
        {
            ...
            //name max 
            //ToDo Add code for second list
            isAll = userListSecond.All(us => us.Name == "Max");
        ...
        public void ReturnsOnlyElementByNameMax()
        {
            ...
            try
            {
                //ToDo Add code for second list
                //name Max
                actualData = userListSecond.Single(us => us.Name == "Max");
                Assert.Fail();
            }
        ...
        public void ReturnsOnlyElementByNameNotOnList()
        {
            ...
            try
            {
                //ToDo Add code for second list
                //name Ldfsdfsfd
                actualData = userListSecond.Single(us => us.Name == "Ldfsdfsfd");
                Assert.Fail();
            }
            catch (InvalidOperationException ie)
            {
        ...
        public void ReturnsOnlyElementOrDefaultByNameNotOnList()
        {
            ...
            //name Ldfsdfsfd
            actualData = userListSecond.SingleOrDefault(us => us.Name == "Ldfsdfsfd");
        ...
        public void ReturnsTheFirstElementByNameNotOnList()
        {
            ...
            try
            {
                //ToDo Add code for second list
                //name Ldfsdfsfd
                actualData = userListSecond.First(us => us.Name == "Ldfsdfsfd");
                Assert.Fail();
            }
            catch (InvalidOperationException ie)
            {
        ...
        public void ReturnsTheFirstElementOrDefaultByNameNotOnList()
        {
            ...
            //ToDo Add code for second list
            //name Ldfsdfsfd
            actualData = userListSecond.FirstOrDefault(us => us.Name == "Ldfsdfsfd");
            Assert.IsTrue(actualData == null);
        }
        ...
        public void GetMaxSalaryFromFirst()
        {
            ...
            actualData = userListFirst.OrderByDescending(us => us.Salary).FirstOrDefault();
